...
function ENT:OnSpawn( PObj )
	local DriverSeat = self:AddDriverSeat( Vector(85.898,0,35.513), Angle(0,-90,9.768) )
	...
	self.Rotor = self:AddRotor( Vector(30,0,100), Angle(0,0,0), 340, -400 )
	self.Rotor:SetHP( 30 )
	
	self.TailRotor = self:AddRotor( Vector( -395.762, -30.433, 78.754 ), Angle( 0, 0, 90 ), 50, 0 )
